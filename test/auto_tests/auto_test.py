...
class AutoTest(unittest.TestCase):
    ...
    def test_friend_by_public_key(self) -> None:
        ...
        self.assertEqual(ex.exception.code, core.TOX_ERR_FRIEND_BY_PUBLIC_KEY_NOT_FOUND)
    ...
    def test_conference_invite(self) -> None:
        ...
        self.assertEqual(
            self.tox1.conference_by_id(self.tox1.conference_get_id(cnum1)), cnum1
        )
        self.assertEqual(
            self.tox1.conference_get_type(cnum1), core.TOX_CONFERENCE_TYPE_TEXT
        )
