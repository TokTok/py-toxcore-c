...
class TestTox(core.Tox_Ptr):
    ...
    def handle_file_recv(self, friend_number: int, file_number: int, kind: int,
    ...
    def handle_conference_peer_name(self, conference_number: int, peer_number: int,
                                    name: bytes) -> None:
    ...
    def handle_conference_invite(self, friend_number: int, type_: core.Tox_Conference_Type,
                                 cookie: bytes) -> None:
