...
class AutoTest(unittest.TestCase):
    ...
    def _wait_for_self_online(self) -> None:
        def is_online() -> bool:
            return bool(self.tox1.connection_status == core.TOX_CONNECTION_NONE or self.tox2.connection_status == core.TOX_CONNECTION_NONE or self.tox3.connection_status == core.TOX_CONNECTION_NONE)
        # At most 20 seconds.
        self._iterate(
            1000,
            is_online,
