...
def handle_types(tokens: Sequence[str], state: List[str], extern: List[str], const_prefix: str) -> bool:
...
def gen_cython(lines: Sequence[str], fun_prefix: str) -> List[str]:
    ...
    for line in lines:
        ...
        event = handle_functions(tokens, state, extern, fun_prefix,
                                 type_prefix, event, params, handlers, install_handlers)
