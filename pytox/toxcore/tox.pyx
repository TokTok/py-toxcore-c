...
cdef void handle_friend_name(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* name, size_t length, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_friend_name(friend_number, name[:length])
cdef void handle_friend_status_message(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* message, size_t length, void* user_data) except *:
...
cdef void handle_friend_request(Tox* tox, const uint8_t* public_key, const uint8_t* message, size_t length, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_friend_request(public_key[:tox_public_key_size()], message[:length])
cdef void handle_friend_message(Tox* tox, Tox_Friend_Number friend_number, Tox_Message_Type type, const uint8_t* message, size_t length, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_friend_message(friend_number, Tox_Message_Type(type), message[:length])
cdef void handle_friend_lossy_packet(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* data, size_t length, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_friend_lossy_packet(friend_number, data[:length])
cdef void handle_friend_lossless_packet(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* data, size_t length, void* user_data) except *:
...
cdef void handle_file_recv_chunk(Tox* tox, Tox_Friend_Number friend_number, Tox_File_Number file_number, uint64_t position, const uint8_t* data, size_t length, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_file_recv_chunk(friend_number, file_number, position, data[:length])
cdef void handle_conference_peer_name(Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Peer_Number peer_number, const uint8_t* name, size_t length, void* user_data) except *:
...
cdef void handle_conference_invite(Tox* tox, Tox_Friend_Number friend_number, Tox_Conference_Type type, const uint8_t* cookie, size_t length, void* user_data) except *:
...
cdef void handle_conference_message(Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Peer_Number peer_number, Tox_Message_Type type, const uint8_t* message, size_t length, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_conference_message(conference_number, peer_number, Tox_Message_Type(type), message[:length])
cdef void handle_conference_title(Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Peer_Number peer_number, const uint8_t* title, size_t length, void* user_data) except *:
...
cdef void handle_group_peer_name(Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number peer_id, const uint8_t* name, size_t length, void* user_data) except *:
...
cdef void handle_group_peer_exit(Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number peer_id, Tox_Group_Exit_Type exit_type, const uint8_t* name, size_t name_length, const uint8_t* part_message, size_t part_message_length, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_group_peer_exit(group_number, peer_id, exit_type, name[:name_length], part_message[:part_message_length])
cdef void handle_group_topic(Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number peer_id, const uint8_t* topic, size_t length, void* user_data) except *:
...
cdef void handle_group_password(Tox* tox, Tox_Group_Number group_number, const uint8_t* password, size_t length, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_group_password(group_number, password[:length])
cdef void handle_group_message(Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number peer_id, Tox_Message_Type type, const uint8_t* message, size_t length, Tox_Group_Message_Id message_id, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_group_message(group_number, peer_id, Tox_Message_Type(type), message[:length], message_id)
cdef void handle_group_private_message(Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number peer_id, Tox_Message_Type type, const uint8_t* message, size_t length, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_group_private_message(group_number, peer_id, Tox_Message_Type(type), message[:length])
cdef void handle_group_custom_packet(Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number peer_id, const uint8_t* data, size_t length, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_group_custom_packet(group_number, peer_id, data[:length])
cdef void handle_group_custom_private_packet(Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number peer_id, const uint8_t* data, size_t length, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_group_custom_private_packet(group_number, peer_id, data[:length])
cdef void handle_group_invite(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* invite_data, size_t length, const uint8_t* group_name, size_t group_name_length, void* user_data) except *:
...
cdef void handle_group_moderation(Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number source_peer_id, Tox_Group_Peer_Number target_peer_id, Tox_Group_Mod_Event mod_type, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_group_moderation(group_number, source_peer_id, target_peer_id, mod_type)
