...
cdef void handle_friend_name(Tox *tox,
    ...
    const uint8_t name[], size_t length, void* user_data) except *:
...
cdef void handle_friend_status_message(
    ...
    const uint8_t message[], size_t length, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_friend_status_message(friend_number, message, length)
cdef void handle_friend_status(
    Tox* tox, Tox_Friend_Number friend_number, Tox_User_Status status, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_friend_status(friend_number, Tox_User_Status(status))
cdef void handle_friend_connection_status(
    Tox* tox, Tox_Friend_Number friend_number, Tox_Connection connection_status, void* user_data) except *:
...
cdef void handle_friend_typing(
    Tox* tox, Tox_Friend_Number friend_number, bool typing, void* user_data) except *:
    (<Tox_Ptr> user_data).handle_friend_typing(friend_number, typing)
cdef void handle_friend_read_receipt(
    Tox* tox, Tox_Friend_Number friend_number, Tox_Friend_Message_Id message_id, void* user_data) except *:
...
cdef void handle_file_chunk_request(
    ...
    size_t length, void* user_data) except *:
...
cdef void handle_file_recv(
    ...
    const uint8_t filename[], size_t filename_length, void* user_data) except *:
...
cdef void handle_file_recv_chunk(
    Tox* tox, Tox_Friend_Number friend_number, Tox_File_Number file_number, uint64_t position,
    const uint8_t data[], size_t length, void* user_data) except *:
...
cdef void handle_conference_invite(
    ...
    const uint8_t cookie[], size_t length, void* user_data) except *:
...
cdef void handle_conference_message(
    ...
    Tox_Message_Type type, const uint8_t message[], size_t length, void* user_data) except *:
...
cdef void handle_conference_title(
    Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Peer_Number peer_number,
    const uint8_t title[], size_t length, void* user_data) except *:
...
cdef void handle_group_message(
    ...
    const uint8_t message[], size_t length, Tox_Group_Message_Id message_id, void* user_data) except *:
...
cdef void handle_group_peer_exit(
    ...
    const uint8_t part_message[], size_t part_message_length, void* user_data) except *:
...
cdef void handle_group_moderation(
    ...
    Tox_Group_Mod_Event mod_type, void* user_data) except *:
