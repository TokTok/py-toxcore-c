...
static void callback_log(Tox *tox, Tox_Log_Level level, const char *file,
...
static void callback_self_connection_status(Tox *tox,
...
static void callback_friend_read_receipt(Tox *tox, uint32_t friendnumber,
    ...
    PyObject_CallMethod((PyObject *)self, "on_friend_read_receipt", "ii",
...
static void callback_conference_invite(Tox *tox, uint32_t friendnumber,
...
static void callback_file_chunk_request(Tox *tox, uint32_t friend_number,
...
static void callback_file_recv(Tox *tox, uint32_t friend_number,
    ...
    if (kind == TOX_FILE_KIND_AVATAR && filename != NULL) {
        ...
        PyObject_CallMethod((PyObject *)self, "on_file_recv", "iiiKs#",
                            friend_number, file_number, kind, file_size,
                            filename_hex, TOX_HASH_LENGTH * 2);
    } else {
        PyObject_CallMethod((PyObject *)self, "on_file_recv", "iiiKs#",
...
static void callback_file_recv_control(Tox *tox, uint32_t friend_number,
...
static void callback_file_recv_chunk(Tox *tox, uint32_t friend_number,
                                     uint32_t file_number, uint64_t position,
                                     const uint8_t *data, size_t length,
                                     void *self) {
    PyObject_CallMethod((PyObject *)self, "on_file_recv_chunk", "iiK" BUF_TC "#",
                        friend_number, file_number, position, data, (Py_ssize_t)length);
}

static void init_options(ToxCore *self, PyObject *pyopts,
                         struct Tox_Options *tox_opts, uint8_t **savedata_data,
                         char **proxy_host) {
    const char *buf = NULL;
    Py_ssize_t sz = 0;
    PyObject *p = NULL;
...
static int init_helper(ToxCore *self, PyObject *args) {
    ...
    tox_callback_conference_peer_list_changed(
        tox, callback_conference_peer_list_changed);
...
static PyObject *ToxCore_new(PyTypeObject *type, PyObject *args,
                             PyObject *kwds) {
...
static PyObject *ToxCore_self_get_address(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_add(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_add_norequest(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_by_public_key(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_get_public_key(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_delete(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_get_connection_status(ToxCore *self,
        PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_exists(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_send_message(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
    ...
    uint32_t ret = tox_friend_send_message(self->tox, friend_num, type, message,
                                           length, &errmsg);
    if (ret == 0) {
...
static PyObject *ToxCore_self_set_name(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_get_name(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_get_name_size(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_get_name(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_get_name_size(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_set_status_message(ToxCore *self,
        PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_set_status(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_get_status_message_size(ToxCore *self,
        PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_get_status_message(ToxCore *self,
        PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_get_status_message(ToxCore *self,
        PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_get_status_message_size(ToxCore *self,
        PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_get_status(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_get_status(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_get_last_online(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
    ...
    PyObject *ret =
        PyObject_CallMethod(datetimeClass, "fromtimestamp", "K", status);

    return ret;
}

static PyObject *ToxCore_self_set_typing(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_friend_get_typing(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_get_friend_list_size(ToxCore *self,
        PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_get_friend_list(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_conference_new(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_conference_delete(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_conference_get_id(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_conference_get_title(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_conference_set_title(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_conference_get_type(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
    ...
    Tox_Conference_Type type =
        tox_conference_get_type(self->tox, conference_number, &error);
...
static PyObject *ToxCore_conference_peer_get_name(ToxCore *self,
        PyObject *args) {
    CHECK_TOX(self);
    ...
    tox_conference_peer_get_name(self->tox, conference_number, peer_number, buf,
                                 &error);
...
static PyObject *ToxCore_conference_invite(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_conference_join(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
    ...
    uint32_t ret =
        tox_conference_join(self->tox, friend_number, cookie, length, &error);
...
static PyObject *ToxCore_conference_send_message(ToxCore *self,
        PyObject *args) {
    CHECK_TOX(self);
    ...
    tox_conference_send_message(self->tox, conference_number, type, message,
                                length, &error);
...
static PyObject *ToxCore_conference_peer_number_is_ours(ToxCore *self,
        PyObject *args) {
    CHECK_TOX(self);
    ...
    Tox_Err_Conference_Peer_Query error;
    bool ret = tox_conference_peer_number_is_ours(self->tox, conference_number,
               peer_number, &error);
    if (error != TOX_ERR_CONFERENCE_PEER_QUERY_OK) {
...
static PyObject *ToxCore_conference_peer_count(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
    ...
    Tox_Err_Conference_Peer_Query error;
    uint32_t count =
        tox_conference_peer_count(self->tox, conference_number, &error);
    if (error != TOX_ERR_CONFERENCE_PEER_QUERY_OK) {
...
static PyObject *ToxCore_conference_get_chatlist_size(ToxCore *self,
        PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_conference_get_chatlist(ToxCore *self,
        PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_file_send(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
    uint32_t friend_number = 0;
    uint32_t kind = 0;
    ...
    uint32_t file_number =
        tox_file_send(self->tox, friend_number, kind, file_size, file_id,
                      filename, filename_length, &err);
...
static PyObject *ToxCore_file_control(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
    uint32_t friend_number = 0;
    ...
    bool ret =
        tox_file_control(self->tox, friend_number, file_number, control, NULL);
    if (!ret) {
...
static PyObject *ToxCore_file_send_chunk(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
    uint32_t friend_number = 0;
    uint32_t file_number = 0;
    uint64_t position = 0;
    ...
    bool ret = tox_file_send_chunk(self->tox, friend_number, file_number,
                                   position, data, length, &err);
    if (!ret) {
...
static PyObject *ToxCore_file_seek(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
    uint32_t friend_number = 0;
    uint32_t file_number = 0;
    uint64_t position = 0;
    ...
    bool ret =
        tox_file_seek(self->tox, friend_number, file_number, position, &err);
...
static PyObject *ToxCore_file_get_file_id(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
    uint32_t friend_number = 0;
    uint32_t file_number = 0;
    ...
    bool ret = tox_file_get_file_id(self->tox, friend_number, file_number,
                                    file_id, &err);
    if (!ret) {
...
static PyObject *ToxCore_self_get_dht_id(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_get_udp_port(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_get_nospam(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_set_nospam(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_get_keys(ToxCore *self, PyObject *args) {
    ...
    PyTuple_SetItem(res, 0,
                    PYSTRING_FromStringAndSize((char *)public_key_hex,
                            TOX_PUBLIC_KEY_SIZE * 2));
    PyTuple_SetItem(res, 1,
                    PYSTRING_FromStringAndSize((char *)secret_key_hex,
                            TOX_PUBLIC_KEY_SIZE * 2));
    return res;
}

static PyObject *ToxCore_bootstrap(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_add_tcp_relay(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_self_get_connection_status(ToxCore *self,
        PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_kill(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_iteration_interval(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_iterate(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_get_savedata_size(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyObject *ToxCore_get_savedata(ToxCore *self, PyObject *args) {
    CHECK_TOX(self);
...
static PyMethodDef Tox_methods[] = {
    ...
    {   "on_self_connection_status", (PyCFunction)ToxCore_callback_stub,
        METH_VARARGS,
    ...
    {   "on_friend_status_message", (PyCFunction)ToxCore_callback_stub,
        METH_VARARGS,
    ...
    {   "on_friend_connection_status", (PyCFunction)ToxCore_callback_stub,
        METH_VARARGS,
    ...
    {   "on_conference_invite", (PyCFunction)ToxCore_callback_stub, METH_VARARGS,
        ...
        "Callback for receiving conference invitations, default implementation "
        "does "
        "nothing.\n\n"
        ".. seealso ::\n"
    ...
    {   "on_conference_peer_name", (PyCFunction)ToxCore_callback_stub,
        METH_VARARGS,
    ...
    {   "on_conference_peer_list_changed", (PyCFunction)ToxCore_callback_stub,
        METH_VARARGS,
    ...
    {   "on_file_recv", (PyCFunction)ToxCore_callback_stub, METH_VARARGS,
        ...
        "Callback for receiving file transfer, default implementation does "
        "nothing."
    },
    {   "on_file_recv_control", (PyCFunction)ToxCore_callback_stub, METH_VARARGS,
        ...
        "Callback for receiving file control, default implementation does "
        "nothing."
    },
    ...
    {   "friend_by_public_key", (PyCFunction)ToxCore_friend_by_public_key,
        METH_VARARGS,
        "friend_by_public_key(friend_id)\n"
        "Return the friend id associated to that client id."
    },
    {   "friend_get_public_key", (PyCFunction)ToxCore_friend_get_public_key,
        METH_VARARGS,
    ...
    {   "friend_send_message", (PyCFunction)ToxCore_friend_send_message,
        METH_VARARGS,
    ...
    {   "friend_get_name_size", (PyCFunction)ToxCore_friend_get_name_size,
        METH_VARARGS,
        "friend_get_name_size(friend_number)\n"
        "Get nickname length of *friend_number*."
    },
    {   "self_set_status_message", (PyCFunction)ToxCore_self_set_status_message,
        METH_VARARGS,
    ...
    {   "friend_get_status_message_size",
        (PyCFunction)ToxCore_friend_get_status_message_size, METH_VARARGS,
        "friend_get_status_message_size(friend_number)\n"
        "Return the length of *friend_number*'s status message."
    },
    {   "friend_get_status_message",
        (PyCFunction)ToxCore_friend_get_status_message, METH_VARARGS,
    ...
    {   "self_get_status_message_size",
        (PyCFunction)ToxCore_self_get_status_message_size, METH_NOARGS,
        "self_get_status_message_size()\n"
    ...
    {   "self_get_status", (PyCFunction)ToxCore_self_get_status, METH_NOARGS,
        "self_get_status()\n"
    ...
    {   "self_get_friend_list_size",
        (PyCFunction)ToxCore_self_get_friend_list_size, METH_NOARGS,
        "self_get_friend_list_size()\n"
    ...
    {   "conference_get_title", (PyCFunction)ToxCore_conference_get_title,
        METH_VARARGS,
        "conference_get_title(conference_number)\n"
        "Returns the title for a conference."
    },
    {   "conference_set_title", (PyCFunction)ToxCore_conference_set_title,
        METH_VARARGS,
        "conference_set_title(conference_number, title)\n"
        "Sets the title for a conference."
    },
    {   "conference_get_type", (PyCFunction)ToxCore_conference_get_type,
        METH_VARARGS,
    ...
    {   "conference_peer_get_name", (PyCFunction)ToxCore_conference_peer_get_name,
        METH_VARARGS,
    ...
    {   "self_get_dht_id", (PyCFunction)ToxCore_self_get_dht_id, METH_NOARGS,
        "self_get_dht_id()\n"
        "get the temporary DHT public key"
    },
    {   "self_get_udp_port", (PyCFunction)ToxCore_self_get_udp_port, METH_NOARGS,
        "self_get_udp_port()\n"
        "Return the UDP port this Tox instance is bound to."
    },
    {   "self_get_nospam", (PyCFunction)ToxCore_self_get_nospam, METH_NOARGS,
        "self_get_nospam()\n"
    ...
    {   "self_get_keys", (PyCFunction)ToxCore_self_get_keys, METH_NOARGS,
        "self_get_keys()\n"
    ...
    {   "self_get_connection_status",
        (PyCFunction)ToxCore_self_get_connection_status, METH_NOARGS,
        "self_get_connection_status()\n"
    ...
    {   "iteration_interval", (PyCFunction)ToxCore_iteration_interval, METH_NOARGS,
        "iteration_interval()\n"
        "returns time (in ms) before the next tox_iterate() needs to be run on "
        "success."
    },
